...
class MarketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create market" do
    assert_difference("Market.count") do
      post markets_url, params: { market: { data: @market.data, name: @market.name, slug: @market.slug } }
    end
  ...
  test "should update market" do
    patch market_url(@market), params: { market: { data: @market.data, name: @market.name, slug: @market.slug } }
