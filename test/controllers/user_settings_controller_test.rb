...
class UserSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_setting" do
    assert_difference("UserSetting.count") do
      post user_settings_url, params: { user_setting: { data: @user_setting.data, user_id: @user_setting.user_id } }
    end
  ...
  test "should update user_setting" do
    patch user_setting_url(@user_setting), params: { user_setting: { data: @user_setting.data, user_id: @user_setting.user_id } }
