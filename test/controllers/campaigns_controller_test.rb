...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference("Campaign.count") do
      post campaigns_url, params: { campaign: { data: @campaign.data, market_id: @campaign.market_id, name: @campaign.name } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { data: @campaign.data, market_id: @campaign.market_id, name: @campaign.name } }
