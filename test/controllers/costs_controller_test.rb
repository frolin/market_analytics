...
class CostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost" do
    assert_difference("Cost.count") do
      post costs_url, params: { cost: { data: @cost.data, date: @cost.date, import_id: @cost.import_id, orderd_id: @cost.orderd_id } }
    end
  ...
  test "should update cost" do
    patch cost_url(@cost), params: { cost: { data: @cost.data, date: @cost.date, import_id: @cost.import_id, orderd_id: @cost.orderd_id } }
