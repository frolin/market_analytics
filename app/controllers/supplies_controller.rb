class SuppliesController < ApplicationController
  ...
  def create
    ...
    product_ids.each { |product_id| SupplyProduct.new(product_id: product_id, supply_id: @supply.id) }
  ...
  def supply_params
    params.require(:supply).permit(:name, :campaign_id)
  end

  def product_ids
    params.dig(:supply, :supply_products) || []
  end
end
