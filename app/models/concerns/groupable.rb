module Groupable
  ...
  included do
    ...
    scope :grouped_by_date, ->(start_date, end_date) { between_dates(start_date, end_date).group('DATE(date)').count }
  ...
  class_methods do
    def group_by_date_with_zero(start_date, end_date)
      ...
      records_grouped_by_date = grouped_by_date(start_date, end_date)
